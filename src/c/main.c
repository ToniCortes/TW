...
GRect b_screen, b_layer1, b_layer2, b_layer3, b_layer4, b_layer5;
TextLayer *layer1, *layer2, *layer3, *layer4, *layer5;
...
static void prv_inbox_received_handler(DictionaryIterator *iter, void *context) {
  ...
  if(fg_color_t) {
      ...
      text_layer_set_text_color(layer5, Param.TextColor );
  ...
  if(showDate_t) {
      ...
      layer_set_hidden((Layer *)layer5, !Param.ShowDate);
  }
...
void bt_handler(bool connected){
  ...
  if (connected){
    ...
    if (Param.BlueTooth) {
      ...
      text_layer_set_text_color(layer4, GColorWhite);
      text_layer_set_text_color(layer5, GColorFolly);
      
      noBTtext(line1, line2, line3, line4);
...
void tick_handler(struct tm *tick_time, TimeUnits units_changed){
  ...
  if (no_bt_countdown > 0) {
    no_bt_countdown --;
    if (no_bt_countdown == 0) {
      date2text(tick_time, line1, line2, line3, line4, day, Param.ShowDate);
      window_set_background_color(window, Param.BackGroundColor);
      text_layer_set_text_color(layer1, Param.TextColor );
      text_layer_set_text_color(layer2, Param.TextColor );
      text_layer_set_text_color(layer3, Param.TextColor );
      ...
      text_layer_set_text(layer4, line4);
      text_layer_set_text(layer5, day);
    }
    return;
  } 
  ...
  if(tick_time->tm_sec  == 59)
  {
    ...
    GRect start = b_layer4;
    GRect finish = GRect(b_layer4.origin.x+180, b_layer4.origin.y, b_layer4.size.h, b_layer4.size.w);
    animate_layer((Layer *)(layer4), &start, &finish, 300, 500);

    start = b_layer3;
    finish = GRect(b_layer3.origin.x+180, b_layer3.origin.y, b_layer3.size.h, b_layer3.size.w);
  ...
  if (tick_time->tm_sec  == 00) {
    ...
    text_layer_set_text_alignment(layer5, GTextAlignmentCenter);
    ...
    GRect start = GRect(b_layer4.origin.x+180, b_layer4.origin.y, b_layer4.size.h, b_layer4.size.w);
    GRect finish = b_layer4;
    animate_layer((Layer *)(layer4), &start, &finish, 300, 500);
    
    start = GRect(b_layer3.origin.x+180, b_layer3.origin.y, b_layer3.size.h, b_layer3.size.w);
    finish = b_layer3;
    animate_layer((Layer *)(layer3), &start, &finish, 300, 500);
...
void window_load(Window *window){
    ...
    b_layer1= GRect(screen_h/1.5,0.6*screen_h, sizey-screen_h*2/1.5, screen_h);
    layer1 = text_layer_create(b_layer1);
    text_layer_set_background_color(layer1, GColorClear);
    text_layer_set_text_color(layer1, Param.TextColor);
    text_layer_set_text_alignment(layer1, RandomPlacement());
    text_layer_set_font(layer1, fonts_load_custom_font  (resource_get_handle (RESOURCE_ID_FONT_TW_25)));   
    layer_add_child(window_get_root_layer(window), (Layer*) layer1);
    
    b_layer2 = GRect(screen_h/5,1.6*screen_h, sizey-screen_h*2/5, screen_h);
    layer2 = text_layer_create(b_layer2);
    text_layer_set_background_color(layer2, GColorClear);
    text_layer_set_text_color(layer2, Param.TextColor);
    text_layer_set_text_alignment(layer2, RandomPlacement());
    text_layer_set_font(layer2, fonts_load_custom_font (resource_get_handle (RESOURCE_ID_FONT_TW_25)));
    layer_add_child(window_get_root_layer(window), (Layer*) layer2);
    
    b_layer3 = GRect(screen_h/5,2.6*screen_h, sizey-screen_h*2/5, screen_h);
    layer3 = text_layer_create(b_layer3);
    text_layer_set_background_color(layer3, GColorClear);
    text_layer_set_text_color(layer3, Param.TextColor);
    text_layer_set_text_alignment(layer3, RandomPlacement());
    text_layer_set_font(layer3, fonts_load_custom_font (resource_get_handle (RESOURCE_ID_FONT_TW_25)));
    layer_add_child(window_get_root_layer(window), (Layer*) layer3);
     
    b_layer4 = GRect(screen_h/2,3.6*screen_h, sizey-screen_h, screen_h);
    layer4 = text_layer_create(b_layer4);
    text_layer_set_background_color(layer4, GColorClear);
    text_layer_set_text_color(layer4, Param.TextColor);
    text_layer_set_text_alignment(layer4, RandomPlacement());
    text_layer_set_font(layer4, fonts_load_custom_font (resource_get_handle (RESOURCE_ID_FONT_TW_25)));
    layer_add_child(window_get_root_layer(window), (Layer*) layer4);
  
    b_layer5 = GRect(screen_h,5*screen_h, sizey-screen_h*2, screen_h);
    layer5 = text_layer_create(b_layer5);
    text_layer_set_background_color(layer5, GColorClear);
    text_layer_set_text_color(layer5, Param.TextColor);
    text_layer_set_text_alignment(layer5, GTextAlignmentCenter);
    text_layer_set_font(layer5, fonts_load_custom_font (resource_get_handle (RESOURCE_ID_FONT_TW_19)));
    layer_add_child(window_get_root_layer(window), (Layer*) layer5);
